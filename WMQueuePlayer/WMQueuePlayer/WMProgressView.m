...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        /* 滑动按钮 */
        _sliderBtn = [[WMSliderBtn alloc] initWithFrame:CGRectMake(0, showY, 44, 44)];
        ...
        _sliderBtn.backgroundColor =  [UIColor magentaColor];
